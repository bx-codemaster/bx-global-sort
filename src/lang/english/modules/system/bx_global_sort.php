 ...
 */
  ...
  $description = '<h3 style="margin-top:0; display:flex; align-items:center; gap:8px;">' . xtc_image(DIR_WS_ICONS.'heading/bx_global_sort.png', 'BX Global Sort', '', '', 'style="max-height: 32px;"') . ' BX Global Sort</h3><p>is a professional management tool for Modified eCommerce Shopsofware that simplifies the sorting of products on the home page and in categories. With a modern drag & drop interface, you can intuitively move products with your mouse – the sorting is saved automatically.</p>';
